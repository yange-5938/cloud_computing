...
app.get('/api', (req, res) => {
  res.json({
    ...
    endpoints: [
      ...
      {method: 'GET', path: '/api/exercise2', description: 'exercise 2 added'},
...
app.get('/api/exercise2/', (req, res) => {
  ...
  /*
  res.json({
    '':"group 100 application deployed using docker"
 });
  */
  res.send('group 100 application deployed using docker');
